...
const PrintWrapper = ({
  ...
  const downloadPrint = () => {
    const target = document.getElementById("componentToPrint");
    target &&
      htmlToImage.toPng(target, { quality: 0.95 }).then(function (dataUrl) {
        var link = document.createElement("a");
        link.download = "dardibook-patient.jpeg";
        const pdf = new jsPDF();
        ...
        pdf.save(
          `${patientData.first_name} ${patientData.last_name} ${new Date(
            time ? time : ""
    ...
    <div className="join-item flex flex-col">
      ...
      <div className="custom-zoom w-full flex items-center justify-center">
        ...
        >
          ...
          <div
            className="absolute top-[25%] left-[25%] w-[50%] h-[50%] bg-cover opacity-20 z-[1]"
